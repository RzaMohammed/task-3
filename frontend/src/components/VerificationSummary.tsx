...
export const VerificationSummary: React.FC<VerificationSummaryProps> = ({
  ...
  return (
    <div className="w-full bg-emerald-950/20 border border-emerald-500/30 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-lg animate-pulse-ring transform transition-transform duration-200 hover:scale-105">
